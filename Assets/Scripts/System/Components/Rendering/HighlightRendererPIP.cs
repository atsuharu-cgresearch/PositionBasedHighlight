...
namespace PositionBasedHighlight
{
    ...
    /// </summary>
    public class HighlightRendererPIP
    {
        ...
        public HighlightRendererPIP(int texSize, SimulationObjectDefinition[] defs, ComputeBuffer particles, ObjectToParticles[] references)
        {
            ...
            compute.SetInt("_NumEdges", edgeIndexBuffer.count / 2); Debug.Log(edgeIndexBuffer.count / 2);
        }
