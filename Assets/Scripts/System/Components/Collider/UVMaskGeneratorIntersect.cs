...
{
    public class UVMaskGeneratorIntersect
    {
        ...
        public UVMaskGeneratorIntersect(TargetMesh tgt, Occluder occ, int texSize)
        {
            target = tgt;
            occluder = occ;
        ...
        private void InitCS()
        {
            compute = Object.Instantiate(Resources.Load<ComputeShader>("ComputeShader/UVMask"));
